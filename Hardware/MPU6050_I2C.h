...
//如果移植程序时只要改一下地方就行了若为,调试端口,前往MPU6050_IIC_IO_Init复用
#define MPU6050_IIC_GPIO                   GPIOB
#define MPU6050_IIC_SCL_Pin                GPIO_Pin_13	         //PB13
#define MPU6050_IIC_SDA_Pin                GPIO_Pin_12	         //PB12

#define	MPU6050_IIC_SCL                    PBout(13)
#define	MPU6050_IIC_SDA                    PBout(12)  
#define	MPU6050_IIC_SDA_IN                 PBin(12)              //读数据端口
